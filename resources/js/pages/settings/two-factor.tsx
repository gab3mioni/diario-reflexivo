...
export default function TwoFactor({
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <h1 className="sr-only">Configurações de autenticação de dois fatores</h1>
                    ...
                    {twoFactorEnabled ? (
                        <div className="flex flex-col items-start justify-start space-y-4">
                            ...
                            <p className="text-muted-foreground">
                                ...
                                no aplicativo compatível com TOTP no seu celular.
                            </p>
                        ...
                        <div className="flex flex-col items-start justify-start space-y-4">
                            ...
                            <p className="text-muted-foreground">
                                ...
                                será solicitado a informar um PIN seguro durante
                                o login. Esse PIN pode ser obtido em um
                                aplicativo compatível com TOTP no seu celular.
                            </p>
